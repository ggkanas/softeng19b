...
public class DayAheadTotalLoadForecastForSpecificDate extends EnergyResource {
    ...
    protected Representation get() throws ResourceException {
        ...
        try {
            ...
            List<DayAheadTLForecastRecordForSpecificDay> result = dataAccess.fetchDayAheadTotalLoadForecastForSpecificDate(
                    areaName,
                    resolution,
                    date
            );
            ...
            return format.generateRepresentation3a(result);
        } catch (Exception e) {
