 ...
 */
public class ActualTotalLoadVsDayAheadTotalLoadForecastForSpecificYear extends EnergyResource {
    ...
    protected Representation get() throws ResourceException {
        ...
        try {
            ...
            List<AVSFRecordForSpecificYear> result = dataAccess.fetchActualTotalLoadVsDayAheadTotalLoadForecastForSpecificYear(
                    areaName,
                    resolution,
                    year
            );
            ...
            return format.generateRepresentation4c(result);
        } catch (Exception e) {
            throw new ResourceException(Status.SERVER_ERROR_INTERNAL, e.getMessage(), e);
        }
